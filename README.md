...
- [Roboto](https://fonts.google.com/specimen/Roboto) as the **font** - Arch: ttf-roboto
...
- [Materia](https://github.com/nana-4/materia-theme) as GTK theme - Arch Install: materia-theme
...
Arch-Based Installs
```
git clone --branch hetzner-arch --single-branch https://github.com/ai4739/titus-awesome ~/.config/awesome
```
